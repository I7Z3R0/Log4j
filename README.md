# Credits
### Full credits to [feihong-cs](https://github.com/feihong-cs). I have just copied this repo for my reference to work with log4j if there is anything which i face. Since the repo has been deleted i copied it from wayback machine
